...
studiesCRCwithCtr
```
🔴 **CONCLUSIONS**: All 11 of the CRC studies have internal cohorts as control
...
Below is a manual annotation regarding the presence or absence of metadata in each study

**FengQ_2015**
This is an Original Article with published novel metagenomic data.
...
**ThomasAM_2018ab_2019c**	 PMID: 30936548 
This work is a meta-analysis of five publicly available datasets + two new cohorts + two "novel Validating Cohorts" 
...
**VogtmannE_2016**
Original Work, patient-level data not available	
...
Additionaly, metabolomic work was done
...
**ZellerG_2014**
PMID 25432777
Original work, with patient-level data
...
🔴 **CONCLUSIONS**: I was able to pull clinical data from 6 out of the 9 studies

## WirbelJ_2018
A folder in raw-data was created containg relaveant published tables that need to be curated for data exploration
```{r}
