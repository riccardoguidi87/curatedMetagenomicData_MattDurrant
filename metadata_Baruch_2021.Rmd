...
I manually produced a table that collect all the clinical infomration present in the paper, the majority of which were actually saved as PDF.  

## Is there presence of any Clinical annotation of patients?
Barush et al have some clinically annotated material that was transcribed manually into a single table (see relative folder)
...
### RNA-Seq
16sRNA-Seq and Metagenome Seq (this concerns ComptTeam)
